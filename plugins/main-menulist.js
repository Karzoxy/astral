...
{title: `${emot} All V3`, rowId: ".menulist all", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀᴍ Semua Mᴇɴᴜ V3"},
{title: `${emot} All V4`, rowId: ".menu6 all", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀᴍ Semua Mᴇɴᴜ V4"},
{title: `${emot} All V5`, rowId: ".mlist all", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀᴍ Semua Mᴇɴᴜ V5"},
{title: `${emot} All V6`, rowId: ".h1 all", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀᴍ Semua Mᴇɴᴜ V6"},
{title: `${emot} All V7`, rowId: ".m9 all", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀᴍ Semua Mᴇɴᴜ V7"},
{title: `${emot} All V8`, rowId: ".m8", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀᴍ Semua Mᴇɴᴜ V8"},
{title: `${emot} All V9`, rowId: ".m10 all", description: "Mᴇɴᴀᴍᴘɪʟᴋᴀᴍ Semua Mᴇɴᴜ V9"},
...
{title: `${emot} Yt ΛƧƬЯΛᄂ-BӨƬ`, rowId: ".karzoxy", description: "My yt Sopport Dong 😭"},

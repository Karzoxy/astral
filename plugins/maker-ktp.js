...
let handler = async (m, { conn, args }) => {
  ...
  if (!args[0]) throw 'ᴍᴀꜱᴜᴋᴋᴀɴ ᴛᴇxᴛ\nContoh\nktp Nik 081268249785|Nama ΛƧƬЯΛᄂ-BӨƬ|Tempat/Tgl Lahir Batam,02-07-2023|Jenis kelamin Laki-laki|Alamat Batam Center|RT/RW 02/02|Gw Di Hotel|Kecamatan Lupa|Agama Islam|Status Perkawinan Jomblo|Pekerjaan nonton anime dirumah|Kewarganegaraan Jepang|Berlaku Hingga Ganti hp lo|Provinsi Kepri|kabupaten ?'
  m.reply('ᴘʀᴏꜱᴇꜱ...')
